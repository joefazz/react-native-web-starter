...
## **Warning!! This branch is no longer going to be maintained because it goes against the whole idea of making a basic starter template by making a decision for you that is not impacted by the tech choice of RNW (unlike TS and navigation). I'm not going to delete it because it's fine but just a warning that you'll probably have to update some stuff if you want to use this.**
